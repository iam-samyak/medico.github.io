...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a style="color:#00CDFF;" href="http://localhost/login/admin_doctor.php">Doctor Record</a>
    ...
    <table class="table" style="margin-top:12rem;">
        <thead>
         <tr>
            ...
            <th style="text-align: center; font-size: 1.5rem;" scope="col">Doctor Name</th>
        ...
        ?>
            <tr>
                ...
                <a style="color:red;" href="http://localhost/login/admin_doctor.php?delete=<?php echo $row['id']; ?>" ><i class="fas fa-trash"></i></a>
            </th>
            </tr>
        <?php
            }
